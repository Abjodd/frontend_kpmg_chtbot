...
.nav-center:hover .nav-logo-box {
  box-shadow: 0 0 32px rgba(0,91,184,0.9), 0 0 12px rgba(0,145,218,0.5), inset 0 1px 0 rgba(255,255,255,0.15);
}
        /* glow halo behind logo box */
        .nav-center::before {
          content: '';
          position: absolute;
        ...
        /* side decorative lines flanking the brand */
        .nav-center-line {
          position: absolute;
          top: 50%; height: 1px; width: 28px;
          background: linear-gradient(to right, transparent, rgba(0,145,218,0.3));
        ...
        .nav-divider {
          width: 1px;
          height: 22px;
          background: rgba(0,145,218,0.14);
        }
        ...
        .nav-role-badge {
          ...
          align-items: center;
          gap: 6px;
          background: rgba(109,32,119,0.16);
          border: 1px solid rgba(109,32,119,0.3);
          border-radius: 2px;
          padding: 3px 10px;
        }
        .nav-role-dot {
        ...
        .nav-logout:hover {
          ...
          box-shadow: 0 0 16px rgba(220,50,50,0.12);
          transform: translateY(-1px);
        }
        .nav-logout::before {
          content: '';
      ...
      <nav className="nav-root">
        ...
        <Link href="/" className="nav-center">
          ...
          <div className="nav-brand-row"></div>
