...
export default function AdminLogin() {
  ...
  const handleLogin = () => {
    ...
    setTimeout(() => {
      const expected = ADMIN_CREDENTIALS[username.trim().toLowerCase()];
      if (expected && expected === password) {
        localStorage.setItem("user", JSON.stringify({ name: username.trim(), role: "Admin" }));
        router.push("/chat");
      } else {
          ...
          <div className="card-inner">
            ...
            <div className="status">
              ...
              <div className="status-text">
                Secure channel <strong>established</strong> · Admin node ready
              </div>
            </div>
          </div>
        </div>
