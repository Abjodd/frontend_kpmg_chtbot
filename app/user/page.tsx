          ...
          <div className="card-inner">
            ...
            {locked && (
              <div className="locked-banner">
                ...
                <div className="locked-text">Account locked after {MAX_ATTEMPTS} failed attempts.<br />Contact your system useristrator to unlock.</div>
              </div>
            )}
            {error && !locked && (
            ...
            <div className="status">
              ...
              <div className="status-text">Secure channel <strong>established</strong> · User node ready</div>
            </div>
          </div>
        </div>
      </div>
